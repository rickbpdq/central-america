...
#The code below builds the basemap, nothing more. No incident information is plotted.
```{r}
...
```{r}
  ...
  # # Plotting the location of each incident
  # geom_point(data = ca_df, aes(x = longitude, y = latitude))+
basemap2 = ggmap(get_googlemap(center = c(lon = -85, lat = 12),
                               zoom = 5.5, scale =2,
                               maptype = 'terrain',
                               color = 'color'))
